...
docker exec rucio-fts-proxy-delegator cp /tmp/x509* /tmp/fts-voms-proxy
docker exec rucio-client cp /tmp/fts-voms-proxy/x509* /tmp
docker exec rucio-server cp /tmp/fts-voms-proxy/x509* /tmp
echo "done"
echo "----------------------------------------------------------------------------------"
